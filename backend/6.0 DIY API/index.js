...
app.get("/filter",(req,res)=>{
  ...
  const jokesOfType = jokes.filter((joke)=> joke.jokeType=== type);
...
app.put("/jokes/:id",(req,res)=>{
  ...
  const searchBox = joke.findIndex((joke)=>joke.id===id);
  jokes[searchBox]= replacementJoke;
...
app.delete("/jokes/all",(req,res)=>{
  ...
  if(userKey===masterKey){
    ...
    res.status(404).json({
      error: "You are not authorized to delete all jokes"
    })
  }
})
