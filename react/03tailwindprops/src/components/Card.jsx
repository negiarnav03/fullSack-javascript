...
function Card(channel, btnText="Default button text"){

    console.log(channel);
    
// props: message they are data we send from one component to another
// props is js object
// props.heading

    return (
        <div className=" bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs  mx-auto">
    <a href="#">
        <img className="rounded-t-base" src="https://images.pexels.com/photos/30363520/pexels-photo-30363520.jpeg" alt="" />
    </a>
    <div className="p-6 text-center">
        <span className="inline-flex items-center bg-brand-softer border border-brand-subtle text-fg-brand-strong text-xs font-medium px-1.5 py-0.5 rounded-sm">
            ...
            {channel.btnText  || "coder forgot to name it"}
        </span>
        <a href="#">
            <h5 className="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">{channel.channel}</h5>
        </a>
